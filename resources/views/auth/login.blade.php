<x-guest-layout>
    <div class="mb-8 text-center">
        ...
        <div class="mt-4 rounded-2xl border border-amber-200 bg-amber-50 px-4 py-3 dark:border-amber-700/60 dark:bg-amber-900/20 text-left">
    ...
    <form method="POST" action="{{ route('login') }}" class="space-y-6">
        ...
        <div class="rounded-2xl border border-slate-300 dark:border-slate-700 px-4 py-3 bg-slate-50/80 dark:bg-slate-800/40">
        ...
        <div class="flex flex-col gap-3 pt-2">
            ...
            <a href="/" class="w-full text-center py-3 text-[10px] font-black text-gray-500 dark:text-slate-400 hover:text-gray-700 dark:hover:text-slate-200 uppercase tracking-[0.2em] transition-colors border border-gray-300 dark:border-slate-700 rounded-2xl hover:border-gray-500 dark:hover:border-slate-500">
                Voltar para o Site
            </a>
        </div>
    </form>
